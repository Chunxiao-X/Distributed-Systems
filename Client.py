    ...
    try:
        ...
        if notes:
            ...
            for note in notes:
                ...
                # Initialize placeholders for Wikipedia summary and link
                wikipedia_summary = None
                wikipedia_link = None
                # Iterate through all text elements in the note
                for text_content in note['texts']:
                    if text_content.startswith("Wikipedia Summary:"):
                        wikipedia_summary = text_content
                    elif text_content.startswith("Wikipedia Link:"):
                        wikipedia_link = text_content
                    else:
                        print(f"  Text: {text_content}")
                if wikipedia_summary:
                    print(f"  {wikipedia_summary}")
                if wikipedia_link:
                    print(f"  {wikipedia_link}")
